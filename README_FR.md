# Skript
Cliquez [ici](https://github.com/SkriptLang/Skript/releases) si vous cherchez la version officielle du plugin et les ressources pour les dernières versions !
...
vous servir si vous *êtes* développeur Java, certaines tâches étant plus rapides à exécuter via Skript, vous pouvez donc l'utiliser pour faire des prototypes, etc.
...
## Pré-requis
Skript-1.8 a besoin de **Spigot 1.8.8** pour fonctionner. Cette fork est uniquement disponible pour Minecraft 1.8. Rendez-vous plus haut si vous recherchez une version compatible avec les dernières versions de Minecraft. Par ailleurs :
...
- si vous utilisiez Skript 2.2 auparavant, votre code doit être légèrement modifié, voir le [tutoriel pour les scripts](https://github.com/Matocolotoe/Skript-1.8/blob/master/tutorials/french/Updates.md).
